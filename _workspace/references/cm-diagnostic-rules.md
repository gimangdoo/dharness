...
| 신호 패턴 | 분류 | Confidence |
|----------|------|-----------|
| `/cm-dashboard` 커맨드 30일간 미사용 | dashboard 미활용 | Low |
...
|-------|-------------|-----------------|
| Compressor 비율 악화 | `.claude/skills/tool-output-compress/SKILL.md` | `.claude/agents/cm-compressor.md` + CLAUDE.md 변경 이력 |
| Injector 토큰 비대화 | `.claude/agents/cm-injector.md` (파라미터) | `_baseline/cm_baseline.json` + CLAUDE.md 변경 이력 |
| Digest 비대화 | `.claude/skills/session-digest/SKILL.md` (추출 규칙) | CLAUDE.md 변경 이력 |
