...
`plugins/cm-harness/hooks/cm_commands.py clusters --min-confidence X.XX`가 다음 SQL 실행:
...
- 클러스터링 재실행 — `/cm-harness:cm-curate`
- 사문화 클러스터 정리 — `/cm-harness:cm-curate`로 decay 적용 후 사용자 확인
