...
> **휴리스틱 임계값 baseline:** Phase 6·8 스킬 트리거 회귀 임계값은 [`heuristics-baseline.md §4`](heuristics-baseline.md#4-phase-68--skill-testing) 단일 출처. 도메인별 override는 `_baseline/intent_profile.md`의 `quality.test_rigor` 필드와 동기 갱신.
