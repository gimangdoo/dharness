...
//   3. uvx 가용 확인 (`uvx --version` — 예: Windows `C:\Users\<user>\AppData\Roaming\Python\Python312\Scripts\uvx.exe`)
...
// === 환경별 수정 영역 ===
const UVX_PATH = "C:\\Users\\<user>\\AppData\\Roaming\\Python\\Python312\\Scripts\\uvx.exe";
