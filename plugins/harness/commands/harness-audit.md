...
하네스 산출물 간 **구조적 정합성**을 점검한다. `plugins/harness/skills/harness/SKILL.md` Phase 9-5 운영/유지보수 워크플로우의 §1 현황 감사 단계를 수동으로 트리거하는 명령이다.

> `/harness:harness-adapt`과 다름: adapt은 **telemetry 기반 행동 drift**, audit은 **파일 간 구조 일관성**.
